        ...
        for lid in lid_list:
            if lid.name == selected_text:
                ...
                if lid.lid_type == LIDType.BC:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "1237LID.png")))
                elif lid.lid_type == LIDType.RG:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "1237LID.png")))
                elif lid.lid_type == LIDType.GR:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "1237LID.png")))
                elif lid.lid_type == LIDType.IT:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "4LID.png")))
                elif lid.lid_type == LIDType.PP:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "5LID.png")))
                elif lid.lid_type == LIDType.RB:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "6LID.png")))
                elif lid.lid_type == LIDType.RD:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "1237LID.png")))
                elif lid.lid_type == LIDType.VS:
                    self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "8LID.png")))
