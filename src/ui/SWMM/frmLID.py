...
class frmLID(QMainWindow, Ui_frmLID):
    ...
    def cboLIDType_currentIndexChanged(self, newIndex):
        ...
        if newIndex == 0: # "Bio-Retention Cell"
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "1bio.png")))
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "2rain.png")))
            self.tabLID.setTabEnabled(0,True)
            self.tabLID.setTabEnabled(1,False)
            self.tabLID.setTabEnabled(2,True)
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "3greenl.png")))
            self.tabLID.setTabEnabled(0,True)
            self.tabLID.setTabEnabled(1,False)
            self.tabLID.setTabEnabled(2,True)
            self.tabLID.setTabEnabled(3,False)
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "4infilt.png")))
            self.tabLID.setTabEnabled(0,True)
            self.tabLID.setTabEnabled(1,False)
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "5perm.png")))
            self.tabLID.setTabEnabled(0,True)
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "6barrel.png")))
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "7rooftop.png")))
            self.tabLID.setTabEnabled(0,True)
            self.tabLID.setTabEnabled(1,False)
            self.tabLID.setTabEnabled(2,False)
            self.tabLID.setTabEnabled(3,False)
            ...
            self.lblImage.setPixmap(QtGui.QPixmap(os.path.join(SWMM_IMAGES, "8veg.png")))
            self.tabLID.setTabEnabled(0,True)
            self.tabLID.setTabEnabled(1,False)
            self.tabLID.setTabEnabled(2,False)
            self.tabLID.setTabEnabled(3,False)
