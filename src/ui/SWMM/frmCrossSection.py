...
SWMM_IMAGES = os.path.join(os.path.dirname(__file__), "swmmimages")
...
class frmCrossSection(QMainWindow, Ui_frmCrossSection):
    ...
    def set_from(self, project):
        ...
        self.listWidget.item(0).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "1rect.png")))

        self.listWidget.item(1).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "2trap.png")))

        self.listWidget.item(2).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "3tri.png")))

        self.listWidget.item(3).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "4para.png")))

        self.listWidget.item(4).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "5power.png")))

        self.listWidget.item(5).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "6irreg.png")))

        self.listWidget.item(6).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "7circ.png")))

        self.listWidget.item(7).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "8force.png")))

        self.listWidget.item(8).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "9filled.png")))

        self.listWidget.item(9).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "10closed.png")))

        self.listWidget.item(10).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "11horiz.png")))

        self.listWidget.item(11).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "12vert.png")))

        self.listWidget.item(12).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "13arch.png")))

        self.listWidget.item(13).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "14recttri.png")))

        self.listWidget.item(14).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "15rectround.png")))

        self.listWidget.item(15).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "16basket.png")))

        self.listWidget.item(16).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "17egg.png")))

        self.listWidget.item(17).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "18horse.png")))

        self.listWidget.item(18).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "19goth.png")))

        self.listWidget.item(19).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "20cat.png")))

        self.listWidget.item(20).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "21semi.png")))

        self.listWidget.item(21).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "22bask.png")))

        self.listWidget.item(22).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "23semi.png")))

        self.listWidget.item(23).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "24custom.png")))

        self.listWidget.item(24).setIcon(QtGui.QIcon(os.path.join(SWMM_IMAGES, "25na.png")))
