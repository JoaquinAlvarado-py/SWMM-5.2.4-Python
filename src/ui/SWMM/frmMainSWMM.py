...
from ui.SWMM.frmStreet import frmStreet
from ui.SWMM.frmInlet import frmInlet
from ui.SWMM.frmInletUsage import frmInletUsage
...
from core.swmm.inlet import Inlet, InletUsage
...
class frmMainSWMM(frmMain):
    ...
    tree_hydraulics_Streets    = ["Streets",     frmStreet]
    tree_hydraulics_Inlets     = ["Inlets",      frmInlet]
    tree_hydraulics_InletUsage = ["Inlet Usage", frmInletUsage]
    ...
    tree_hydraulics_items = [
        ...
        tree_hydraulics_Streets,
        tree_hydraulics_Inlets,
        tree_hydraulics_InletUsage,
    ...
    def __init__(self, q_application):
        ...
        self.tree_types = {
            ...
            self.tree_hydraulics_Streets[0]: Street,
            self.tree_hydraulics_Inlets[0]: Inlet,
            self.tree_hydraulics_InletUsage[0]: InletUsage,
