...
class ProjectWriter(InputFileWriterBase):
    ...
    def __init__(self):
        ...
        self.write_streets = SectionWriterAsList("[STREETS]", StreetWriter,
            ";;Name          \tTcrown    \tHcurb     \tSx        \tnRoad     \ta         \tW         \tSides     \tTback     \tSback     \tnBack\n"
            ";;--------------\t----------\t----------\t----------\t----------\t----------\t----------\t----------\t----------\t----------\t----------")
        # street cross-section geometry

        self.write_inlets = SectionWriterAsList("[INLETS]", InletWriter,
            ";;Name          \tType            \tParameters\n"
            ";;--------------\t----------------\t----------")
        # inlet design definitions

        self.write_inlet_usage = SectionWriterAsList("[INLET_USAGE]", InletUsageWriter,
